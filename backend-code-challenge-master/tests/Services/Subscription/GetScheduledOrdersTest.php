...
class GetScheduledOrdersTest extends \PHPUnit\Framework\TestCase
{
    public function testItGeneratesForWeeklySubscription()
    {
        ...
        $weeks        = 6;
        $subscription = new Subscription($date->copy(),Subscription::STATUS_ACTIVE, Subscription::PLAN_WEEKLY);
    ...
    public function testItGeneratesForFortnightlySubscription()
    {
        ...
        $weeks        = 6;
        $subscription = new Subscription($date->copy(),Subscription::STATUS_ACTIVE, Subscription::PLAN_FORTNIGHTLY);
    ...
    {
        $subscription = new Subscription(null, Subscription::STATUS_CANCELLED, Subscription::PLAN_FORTNIGHTLY);
